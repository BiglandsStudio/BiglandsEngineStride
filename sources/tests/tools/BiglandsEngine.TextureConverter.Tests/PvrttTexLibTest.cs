...
namespace BiglandsEngine.TextureConverter.Tests
{
    public class PvrttTexLibTest : IDisposable
    {
        ...
        [Theory(Skip = "Need check")]
        [InlineData("TextureArray_WMipMaps_RGBA8888.pvr", BiglandsEngine.Graphics.PixelFormat.ETC2_RGBA)]
        [InlineData("TextureCube_WMipMaps_RGBA8888.pvr", BiglandsEngine.Graphics.PixelFormat.ETC2_RGBA)]
