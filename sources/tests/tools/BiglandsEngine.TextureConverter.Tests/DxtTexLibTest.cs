...
namespace BiglandsEngine.TextureConverter.Tests
{
    public class DxtTexLibTest : IDisposable
    {
        ...
        public void CanHandleRequestTest()
        {
            ...
            Assert.True(library.CanHandleRequest(image, new CompressingRequest(BiglandsEngine.Graphics.PixelFormat.BC3_UNorm)));
        ...
        public void DecompressFailTest(string file)
        {
            ...
            Assert.True(image.Format == BiglandsEngine.Graphics.PixelFormat.B8G8R8A8_UNorm);
        ...
        [Theory(Skip = "Need check")]
        [InlineData("TextureArray_WMipMaps_BGRA8888.dds", BiglandsEngine.Graphics.PixelFormat.BC3_UNorm)]
        [InlineData("TextureCube_WMipMaps_BGRA8888.dds", BiglandsEngine.Graphics.PixelFormat.BC3_UNorm)]
        [InlineData("Texture3D_WMipMaps_BGRA8888.dds", BiglandsEngine.Graphics.PixelFormat.BC3_UNorm)]
        [InlineData("TextureArray_WMipMaps_BGRA8888.dds", BiglandsEngine.Graphics.PixelFormat.BC1_UNorm)]
        [InlineData("TextureCube_WMipMaps_BGRA8888.dds", BiglandsEngine.Graphics.PixelFormat.BC1_UNorm)]
        [InlineData("Texture3D_WMipMaps_BGRA8888.dds", BiglandsEngine.Graphics.PixelFormat.BC1_UNorm)]
        public void CompressTest(string file, BiglandsEngine.Graphics.PixelFormat format)
        {
            TexImage image = TestTools.Load(library, file);
