...
namespace BiglandsEngine.TextureConverter.Tests
{
    public class TextureToolTest : IDisposable
    {
        ...
        [Theory(Skip = "Need check")]
        [InlineData("TextureArray_WMipMaps_BC3.dds")]
        public void ConvertToBiglandsEngineImageTest(string file)
        {
            TexImage image = texTool.Load(Module.PathToInputImages + file);
            var sd = texTool.ConvertToBiglandsEngineImage(image);
        ...
        [Theory(Skip = "Need check")]
        [InlineData("TextureArray_WMipMaps_BC3.dds")]
        public void LoadBiglandsEngineImageTest(string file)
        {
            TexImage image = texTool.Load(Module.PathToInputImages + file);
