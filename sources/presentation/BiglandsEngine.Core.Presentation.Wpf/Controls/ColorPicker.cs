...
using Color = BiglandsEngine.Core.Mathematics.Color;
        ...
        private void RenderColorPickerSurface()
        {
            ...
            if (colorPickerRenderSurface != null)
            {
                ...
                if (!double.IsNaN(colorPickerRenderSurface.Width) && !double.IsNaN(colorPickerRenderSurface.Height))
                {
                    ...
                    int rawBiglandsEngine = (width * pf.BitsPerPixel + 7) / 8;
                    var rawImage = new byte[rawBiglandsEngine * height];
                    ...
                    colorPickerRenderSurface.Fill = new DrawingBrush(new ImageDrawing(BitmapSource.Create(width, height, 96, 96, pf, null, rawImage, rawBiglandsEngine), new Rect(0.0f, 0.0f, width, height)));
                }
            }
        }
