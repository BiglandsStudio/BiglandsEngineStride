...
using BiglandsEngine.Core.Presentation.Core;
...
using BiglandsEngine.Core.TypeConverters;
...
namespace BiglandsEngine.Core.Presentation.Quantum.ViewModels
{
    public class NodeViewModel : DispatcherViewModel, IDynamicMetaObjectProvider
    {
        ...
        /// </summary>
        /// <param name="name">The name of the <see cref="BiglandsEngine.Core.Presentation.Quantum.ViewModels.NodeViewModel"/> to look for.</param>
        ...
        /// <summary>
        /// Indicates whether the given name is reserved for the name of a property in an <see cref="BiglandsEngine.Core.Presentation.Quantum.ViewModels.NodeViewModel"/>. Any children node with a colliding name will
