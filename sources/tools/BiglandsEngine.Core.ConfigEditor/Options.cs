...
namespace BiglandsEngine.ConfigEditor
{
        ...
        public string BiglandsEnginePath
        {
            ...
            set
            {
                if (string.IsNullOrWhiteSpace(value))
                    throw new ArgumentException("Invalid 'BiglandsEnginePath' property value");
                BiglandsEnginePath = value;
            }
        }

        [XmlElement]
        public string BiglandsEngineConfigFilename { get; set; }
