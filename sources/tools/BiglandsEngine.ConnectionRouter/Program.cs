...
namespace BiglandsEngine.ConnectionRouter
{
    partial class Program
    {
        ...
        static int Main(string[] args)
        {
            ...
            var p = new OptionSet
                {
                    ...
                    "BiglandsEngine Router Server - Version: "
                    +
                    String.Format(
                        "{0}.{1}.{2}",
            ...
            try
            {
                ...
                using (var mutex = FileLock.TryLock("connectionrouter.lock"))
                {
                    if (mutex == null)
                    {
                        Console.WriteLine("Another instance of BiglandsEngine Router is already running");
                        return -1;
                    }
        ...
        private static void SetupTrayIcon(string logFileName)
        {
            ...
            notifyIcon.Text = "BiglandsEngine Connection Router";
            ...
            GlobalLogger.GlobalMessageLogged += (logMessage) =>
            {
                ...
                notifyIcon.ShowBalloonTip(2000, "BiglandsEngine Connection Router", logMessage.ToString(), toolTipIcon);
            };
