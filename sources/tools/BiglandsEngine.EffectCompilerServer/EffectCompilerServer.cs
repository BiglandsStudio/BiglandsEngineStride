...
using BiglandsEngine.Assets.Effect;
using BiglandsEngine.ConnectionRouter;
using BiglandsEngine.Engine.Network;
using BiglandsEngine.Shaders.Compiler;
using BiglandsEngine.Shaders.Compiler.Internals;

namespace BiglandsEngine.EffectCompilerServer
{
    /// <summary>
    ...
    public class EffectCompilerServer : RouterServiceServer
    {
        ...
        public EffectCompilerServer() : base($"/service/BiglandsEngine.EffectCompilerServer/{BiglandsEngineVersion.NuGetVersion}/BiglandsEngine.EffectCompilerServer.exe")
        {
