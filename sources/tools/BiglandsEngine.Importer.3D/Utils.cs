...
namespace BiglandsEngine.Importer.ThreeD
{
    public static class Utils
    {
        ...
        public static Matrix ToBiglandsEngineMatrix(this Matrix4x4 matrix)
        {
        ...
        public static Core.Mathematics.Vector3 ToBiglandsEngineVector3(this System.Numerics.Vector3 v)
            => Unsafe.As<System.Numerics.Vector3, Core.Mathematics.Vector3>(ref v);

        public static Color ToBiglandsEngineColor(this System.Numerics.Vector4 v)
            => new Color(v.X, v.Y, v.Z, v.W);

        public static Core.Mathematics.Quaternion ToBiglandsEngineQuaternion(this AssimpQuaternion q)
        ...
        public static CompressedTimeSpan AiTimeToBiglandsEngineTimeSpan(double time, double aiTickPerSecond)
        {
