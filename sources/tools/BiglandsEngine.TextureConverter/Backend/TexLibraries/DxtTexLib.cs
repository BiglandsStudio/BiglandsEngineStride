...
using BiglandsEngine.TextureConverter.DxtWrapper;
using BiglandsEngine.TextureConverter.Requests;

using Utilities = BiglandsEngine.TextureConverter.DxtWrapper.Utilities;
...
namespace BiglandsEngine.TextureConverter.TexLibraries
{
    ...
    internal class DxtTexLib : ITexLibrary
    {
        ...
        /// <summary>
        /// Retrieves the native format from <see cref="BiglandsEngine.Graphics.PixelFormat"/>.
        /// </summary>
        /// <param name="format">The format.</param>
        /// <returns>The corresponding <see cref="DXGI_FORMAT"/></returns>
        private DXGI_FORMAT RetrieveNativeFormat(BiglandsEngine.Graphics.PixelFormat format)
        {
