...
using BiglandsEngine.TextureConverter.PvrttWrapper;
...
namespace BiglandsEngine.TextureConverter.TexLibraries
{
    ...
    internal class PvrttTexLib : ITexLibrary
    {
        ...
        private void SwitchChannels(TexImage image, PvrTextureLibraryData libraryData, SwitchingBRChannelsRequest request)
        {
            ...
            switch (image.Format)
            {
                case BiglandsEngine.Graphics.PixelFormat.B8G8R8A8_UNorm:
                    image.Format = BiglandsEngine.Graphics.PixelFormat.R8G8B8A8_UNorm; break;
                case BiglandsEngine.Graphics.PixelFormat.B8G8R8A8_Typeless:
                    image.Format = BiglandsEngine.Graphics.PixelFormat.R8G8B8A8_Typeless; break;
                case BiglandsEngine.Graphics.PixelFormat.B8G8R8A8_UNorm_SRgb:
                    image.Format = BiglandsEngine.Graphics.PixelFormat.R8G8B8A8_UNorm_SRgb; break;
                case BiglandsEngine.Graphics.PixelFormat.R8G8B8A8_Typeless:
                    image.Format = BiglandsEngine.Graphics.PixelFormat.B8G8R8A8_Typeless; break;
                case BiglandsEngine.Graphics.PixelFormat.R8G8B8A8_UNorm:
                    image.Format = BiglandsEngine.Graphics.PixelFormat.B8G8R8A8_UNorm; break;
                case BiglandsEngine.Graphics.PixelFormat.R8G8B8A8_UNorm_SRgb:
                    image.Format = BiglandsEngine.Graphics.PixelFormat.B8G8R8A8_UNorm_SRgb; break;
                default:
        ...
        /// <summary>
        /// Transposes face data since Pvrtt keeps the format of data [mipMap][face], but BiglandsEngine uses [face][mipMap]
        /// </summary>
        ...
        public void GenerateNormalMap(TexImage image, PvrTextureLibraryData libraryData, NormalMapGenerationRequest request)
        {
            ...
            request.NormalMap.Format = BiglandsEngine.Graphics.PixelFormat.R8G8B8A8_UNorm;
        ...
        /// </returns>
        private bool SupportFormat(BiglandsEngine.Graphics.PixelFormat format)
        {
            switch (format)
            {
                case BiglandsEngine.Graphics.PixelFormat.R32G32B32A32_Float:
                case BiglandsEngine.Graphics.PixelFormat.R32G32B32_Float:
                case BiglandsEngine.Graphics.PixelFormat.R32G32B32A32_UInt:
                case BiglandsEngine.Graphics.PixelFormat.R32G32B32_UInt:
                case BiglandsEngine.Graphics.PixelFormat.R32G32B32A32_SInt:
                case BiglandsEngine.Graphics.PixelFormat.R32G32B32_SInt:
                case BiglandsEngine.Graphics.PixelFormat.R16G16B16A16_UNorm:
                case BiglandsEngine.Graphics.PixelFormat.R16G16B16A16_UInt:
                case BiglandsEngine.Graphics.PixelFormat.R16G16B16A16_SNorm:
                case BiglandsEngine.Graphics.PixelFormat.R16G16B16A16_SInt:
                case BiglandsEngine.Graphics.PixelFormat.R8G8B8A8_UNorm_SRgb:
                case BiglandsEngine.Graphics.PixelFormat.R8G8B8A8_UNorm:
                case BiglandsEngine.Graphics.PixelFormat.R8G8B8A8_UInt:
                case BiglandsEngine.Graphics.PixelFormat.R8G8B8A8_SNorm:
                case BiglandsEngine.Graphics.PixelFormat.R8G8B8A8_SInt:
                case BiglandsEngine.Graphics.PixelFormat.B8G8R8A8_UNorm_SRgb:
                case BiglandsEngine.Graphics.PixelFormat.B8G8R8A8_UNorm:

                case BiglandsEngine.Graphics.PixelFormat.ETC1:
                case BiglandsEngine.Graphics.PixelFormat.ETC2_RGB:
                case BiglandsEngine.Graphics.PixelFormat.ETC2_RGB_SRgb:
                case BiglandsEngine.Graphics.PixelFormat.ETC2_RGBA:
                case BiglandsEngine.Graphics.PixelFormat.ETC2_RGBA_SRgb:
                case BiglandsEngine.Graphics.PixelFormat.ETC2_RGB_A1:
                case BiglandsEngine.Graphics.PixelFormat.EAC_R11_Unsigned:
                case BiglandsEngine.Graphics.PixelFormat.EAC_R11_Signed:
                case BiglandsEngine.Graphics.PixelFormat.EAC_RG11_Unsigned:
                case BiglandsEngine.Graphics.PixelFormat.EAC_RG11_Signed:
                    return true;
                default:
                    return false;
            }
        ...
        private UInt64 RetrieveNativeFormat(BiglandsEngine.Graphics.PixelFormat format)
        {
            switch (format)
            {
                case BiglandsEngine.Graphics.PixelFormat.ETC1:
        ...
        private EPVRTVariableType RetrieveNativePixelType(BiglandsEngine.Graphics.PixelFormat format)
        {
            switch (format)
            {
                case BiglandsEngine.Graphics.PixelFormat.R32G32B32A32_Float:
                ...
                //case BiglandsEngine.Framework.Graphics.PixelFormat.R16G16B16A16_Float:
        ...
        private BiglandsEngine.Graphics.PixelFormat RetrieveFormatFromNativeData(PVRTextureHeader header)
        {
            BiglandsEngine.Graphics.PixelFormat format = header.GetFormat();
            if (format == BiglandsEngine.Graphics.PixelFormat.R32G32B32A32_Float)
            {
                switch (header.GetChannelType())
                {
                    case EPVRTVariableType.ePVRTVarTypeFloat:
                        return BiglandsEngine.Graphics.PixelFormat.R32G32B32A32_Float;
                    case EPVRTVariableType.ePVRTVarTypeUnsignedInteger:
                        return BiglandsEngine.Graphics.PixelFormat.R32G32B32A32_UInt;
                    case EPVRTVariableType.ePVRTVarTypeSignedInteger:
                        return BiglandsEngine.Graphics.PixelFormat.R32G32B32A32_SInt;
                }
            }
            else if (format == BiglandsEngine.Graphics.PixelFormat.R16G16B16A16_UNorm)
            {
                switch (header.GetChannelType())
                {
                    case EPVRTVariableType.ePVRTVarTypeUnsignedShortNorm:
                        return BiglandsEngine.Graphics.PixelFormat.R16G16B16A16_UNorm;
                    case EPVRTVariableType.ePVRTVarTypeUnsignedShort:
                        return BiglandsEngine.Graphics.PixelFormat.R16G16B16A16_UInt;
                    case EPVRTVariableType.ePVRTVarTypeSignedShortNorm:
                        return BiglandsEngine.Graphics.PixelFormat.R16G16B16A16_SNorm;
                    case EPVRTVariableType.ePVRTVarTypeSignedShort:
                        return BiglandsEngine.Graphics.PixelFormat.R16G16B16A16_SInt;
                }
            }
            else if (format == BiglandsEngine.Graphics.PixelFormat.R8G8B8A8_UNorm)
            {
                switch (header.GetChannelType())
                {
                    case EPVRTVariableType.ePVRTVarTypeUnsignedByteNorm:
                        {
                            if (header.GetColourSpace() == EPVRTColourSpace.ePVRTCSpacelRGB)
                                return BiglandsEngine.Graphics.PixelFormat.R8G8B8A8_UNorm;
                            else
                                return BiglandsEngine.Graphics.PixelFormat.R8G8B8A8_UNorm_SRgb;
                        }
                    case EPVRTVariableType.ePVRTVarTypeUnsignedByte:
                        return BiglandsEngine.Graphics.PixelFormat.R8G8B8A8_UInt;
                    case EPVRTVariableType.ePVRTVarTypeSignedByteNorm:
                        return BiglandsEngine.Graphics.PixelFormat.R8G8B8A8_SNorm;
                    case EPVRTVariableType.ePVRTVarTypeSignedByte:
                        return BiglandsEngine.Graphics.PixelFormat.R8G8B8A8_SInt;
                }
            }
        ...
        private EPVRTColourSpace RetrieveNativeColorSpace(BiglandsEngine.Graphics.PixelFormat format)
        {
