...
using BiglandsEnginePixelFormat = BiglandsEngine.Graphics.PixelFormat;
...
namespace FreeImageAPI
{
    ...
    internal static partial class FreeImage
	{
        ...
        /// </summary>
        /// <param name="format">The <see cref="BiglandsEngine.Graphics.PixelFormat"/> of the image.</param>
        /// <param name="type">Returns the type used for the new bitmap.</param>
        /// <param name="bpp">Returns the color depth for the new bitmap.</param>
        /// <param name="redMask">Returns the red_mask for the new bitmap.</param>
        /// <param name="greenMask">Returns the green_mask for the new bitmap.</param>
        ...
        /// </returns>
        public static bool GetFormatParameters(
            BiglandsEnginePixelFormat format,
            out FREE_IMAGE_TYPE type,
            out uint bpp,
            out uint redMask,
            out uint greenMask,
            out uint blueMask)
        {
            ...
            switch (format)
            {
                case BiglandsEnginePixelFormat.R32G32B32A32_Float:
                    type = FREE_IMAGE_TYPE.FIT_RGBAF;
                    bpp = 128;
                    break;
                case BiglandsEnginePixelFormat.R32G32B32_Float:
                    type = FREE_IMAGE_TYPE.FIT_RGBF;
                    bpp = 96;
                    break;
                case BiglandsEnginePixelFormat.R16G16B16A16_Typeless:
                case BiglandsEnginePixelFormat.R16G16B16A16_Float:
                case BiglandsEnginePixelFormat.R16G16B16A16_UNorm:
                case BiglandsEnginePixelFormat.R16G16B16A16_UInt:
                case BiglandsEnginePixelFormat.R16G16B16A16_SNorm:
                case BiglandsEnginePixelFormat.R16G16B16A16_SInt:
                    type = FREE_IMAGE_TYPE.FIT_RGBA16;
                    bpp = 64;
                    break;
                case BiglandsEnginePixelFormat.D32_Float:
                case BiglandsEnginePixelFormat.R32_Float:
                    type = FREE_IMAGE_TYPE.FIT_FLOAT;
                    bpp = 32;
                    break;
                case BiglandsEnginePixelFormat.R32_SInt:
                    type = FREE_IMAGE_TYPE.FIT_INT32;
                    bpp = 32;
                    break;
                case BiglandsEnginePixelFormat.R32_UInt:
                    type = FREE_IMAGE_TYPE.FIT_UINT32;
                    bpp = 32;
                    break;
                case BiglandsEnginePixelFormat.R16_SInt:
                    type = FREE_IMAGE_TYPE.FIT_INT16;
                    bpp = 16;
                    break;
                case BiglandsEnginePixelFormat.R16_UInt:
                    type = FREE_IMAGE_TYPE.FIT_UINT16;
                    bpp = 16;
                    break;
                case BiglandsEnginePixelFormat.R32_Typeless:
                    type = FREE_IMAGE_TYPE.FIT_BITMAP;
                    bpp = 32;
                    break;
                case BiglandsEnginePixelFormat.R8G8B8A8_Typeless:
                case BiglandsEnginePixelFormat.R8G8B8A8_UNorm:
                case BiglandsEnginePixelFormat.R8G8B8A8_UNorm_SRgb:
                case BiglandsEnginePixelFormat.R8G8B8A8_UInt:
                case BiglandsEnginePixelFormat.R8G8B8A8_SNorm:
                case BiglandsEnginePixelFormat.R8G8B8A8_SInt:
                    type = FREE_IMAGE_TYPE.FIT_BITMAP;
                    bpp = 32;
                    redMask = FI_RGBA_RED_MASK;
                    greenMask = FI_RGBA_GREEN_MASK;
                    blueMask = FI_RGBA_BLUE_MASK;
                    break;
                case BiglandsEnginePixelFormat.R16G16_Typeless:
                case BiglandsEnginePixelFormat.R16G16_Float:
                case BiglandsEnginePixelFormat.R16G16_UNorm:
                case BiglandsEnginePixelFormat.R16G16_UInt:
                case BiglandsEnginePixelFormat.R16G16_SNorm:
                case BiglandsEnginePixelFormat.R16G16_SInt:
                    type = FREE_IMAGE_TYPE.FIT_BITMAP;
                    bpp = 32;
                    redMask = 0xFFFF0000;
                    greenMask = 0x0000FFFF;
                    break;
                case BiglandsEnginePixelFormat.B8G8R8A8_Typeless:
                case BiglandsEnginePixelFormat.B8G8R8A8_UNorm_SRgb:
                case BiglandsEnginePixelFormat.B8G8R8X8_Typeless:
                case BiglandsEnginePixelFormat.B8G8R8X8_UNorm_SRgb:
                case BiglandsEnginePixelFormat.B8G8R8A8_UNorm:
                case BiglandsEnginePixelFormat.B8G8R8X8_UNorm:
                    type = FREE_IMAGE_TYPE.FIT_BITMAP;
                    bpp = 32;
                ...
                case BiglandsEnginePixelFormat.B5G6R5_UNorm:
                    type = FREE_IMAGE_TYPE.FIT_BITMAP;
                    bpp = 16;
                    redMask = FI16_565_RED_MASK;
                    greenMask = FI16_565_GREEN_MASK;
                    blueMask = FI16_565_BLUE_MASK;
                    break;
                case BiglandsEnginePixelFormat.B5G5R5A1_UNorm:
                    type = FREE_IMAGE_TYPE.FIT_BITMAP;
                    bpp = 16;
                    redMask = FI16_555_RED_MASK;
                    greenMask = FI16_555_GREEN_MASK;
                    blueMask = FI16_555_BLUE_MASK;
                    break;
                case BiglandsEnginePixelFormat.R16_Typeless:
                case BiglandsEnginePixelFormat.R16_Float:
                case BiglandsEnginePixelFormat.D16_UNorm:
                case BiglandsEnginePixelFormat.R16_UNorm:
                case BiglandsEnginePixelFormat.R16_SNorm:
                    type = FREE_IMAGE_TYPE.FIT_UINT16;
                    bpp = 16;
                    break;
                case BiglandsEnginePixelFormat.R8G8_Typeless:
                case BiglandsEnginePixelFormat.R8G8_UNorm:
                case BiglandsEnginePixelFormat.R8G8_UInt:
                case BiglandsEnginePixelFormat.R8G8_SNorm:
                case BiglandsEnginePixelFormat.R8G8_SInt:
                    type = FREE_IMAGE_TYPE.FIT_BITMAP;
                    bpp = 16;
                    redMask = 0xFF00;
                    greenMask= 0x00FF;
                    break;
                case BiglandsEnginePixelFormat.R8_Typeless:
                case BiglandsEnginePixelFormat.R8_UNorm:
                case BiglandsEnginePixelFormat.R8_UInt:
                case BiglandsEnginePixelFormat.R8_SNorm:
                case BiglandsEnginePixelFormat.R8_SInt:
                case BiglandsEnginePixelFormat.A8_UNorm:
                    type = FREE_IMAGE_TYPE.FIT_BITMAP;
                    bpp = 8;
                    break;
                case BiglandsEnginePixelFormat.R1_UNorm:
                    type = FREE_IMAGE_TYPE.FIT_BITMAP;
                    bpp = 1;
                    break;
                default:
