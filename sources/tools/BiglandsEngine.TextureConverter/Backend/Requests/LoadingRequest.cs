...
{
    /// <summary>
    /// Request to load a texture, either from a file, or from memory with an <see cref="TexImage"/> or a <see cref="BiglandsEngine.Graphics.Image"/>
    /// </summary>
    internal class LoadingRequest : IRequest
    {
        /// <summary>
        /// The different loading mode : TexImage, file, BiglandsEngine Image
        /// </summary>
        ...
        /// <summary>
        /// The BiglandsEngine Image to be loaded
        /// </summary>
        public BiglandsEngine.Graphics.Image XkImage;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoadingRequest"/> class to load a texture from a <see cref="BiglandsEngine.Graphics.Image"/> instance.
        /// </summary>
        /// <param name="image">The image.</param>
        /// <param name="loadAsSRgb">Indicate if the input file should be loaded as in sRGB file</param>
        public LoadingRequest(BiglandsEngine.Graphics.Image image, bool loadAsSRgb)
        {
            XkImage = image;
