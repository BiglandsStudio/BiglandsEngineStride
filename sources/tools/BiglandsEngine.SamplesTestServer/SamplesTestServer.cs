...
using BiglandsEngine.Games.Testing;
using BiglandsEngine.Games.Testing.Requests;
...
namespace BiglandsEngine.SamplesTestServer
{
    public class SamplesTestServer : RouterServiceServer
    {
        ...
        public SamplesTestServer() : base($"/service/BiglandsEngine.SamplesTestServer/{BiglandsEngineVersion.NuGetVersion}/BiglandsEngine.SamplesTestServer.exe")
        {
