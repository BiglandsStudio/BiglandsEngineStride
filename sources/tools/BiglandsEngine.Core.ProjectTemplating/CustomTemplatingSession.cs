...
namespace BiglandsEngine.Core.ProjectTemplating
{
    internal class CustomTemplatingSession : ITextTemplatingSession
    {
        private readonly dynamic expando;
        private readonly IDictionary<string, object> backend;

        public CustomTemplatingSession(ExpandoObject expando)
        {
