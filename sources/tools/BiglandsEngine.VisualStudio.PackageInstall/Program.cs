...
namespace BiglandsEngine.VisualStudio.PackageInstall
{
    class Program
    {
        static int Main(string[] args)
        {
            try
            {
                ...
                const string vsixFile = "BiglandsEngine.vsix";
                ...
                switch (args[0])
                {
                    ...
                    case "/uninstall":
                    {
                        ...
                        RunVsixInstaller(ideInfo.VsixInstallerPath, "/uninstall:BiglandsEngine.VisualStudio.Package.2022 /quiet");
                        break;
                    }
                }
