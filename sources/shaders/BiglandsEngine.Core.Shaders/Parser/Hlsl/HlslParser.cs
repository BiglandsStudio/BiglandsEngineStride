...
// Use BiglandsEngineGrammar (compatiable with HLSL), in order to avoid initializing both BiglandsEngine and HLSL grammar
using HlslGrammar = BiglandsEngine.Core.Shaders.Grammar.BiglandsEngine.BiglandsEngineGrammar;

namespace BiglandsEngine.Core.Shaders.Parser.Hlsl
{
    /// <summary>
    /// HlslParser.
    /// </summary>
