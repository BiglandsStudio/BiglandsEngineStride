...
using BiglandsEngine.Core.Shaders.Grammar;
using BiglandsEngine.Core.Shaders.Utility;

using SourceLocation = BiglandsEngine.Core.Shaders.Ast.SourceLocation;
using SourceSpan = BiglandsEngine.Core.Shaders.Ast.SourceSpan;

namespace BiglandsEngine.Core.Shaders.Parser
{
    /// <summary>
    /// Parser class.
    /// </summary>
