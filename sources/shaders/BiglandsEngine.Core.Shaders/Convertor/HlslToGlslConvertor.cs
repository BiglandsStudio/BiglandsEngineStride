...
using System.Linq;
using System.Text;
using BiglandsEngine.Core.Shaders.Analysis;
using BiglandsEngine.Core.Shaders.Analysis.Hlsl;
using BiglandsEngine.Core.Shaders.Ast;
using BiglandsEngine.Core.Shaders.Ast.Glsl;
...
using BiglandsEngine.Core.Shaders.Writer.Hlsl;
using LayoutQualifier = BiglandsEngine.Core.Shaders.Ast.Glsl.LayoutQualifier;
using ParameterQualifier = BiglandsEngine.Core.Shaders.Ast.ParameterQualifier;
using StorageQualifier = BiglandsEngine.Core.Shaders.Ast.StorageQualifier;
...
namespace BiglandsEngine.Core.Shaders.Convertor
{
    ...
    public class HlslToGlslConvertor : ShaderRewriter
    {
        ...
        private void ApplyStd140Layout()
        {
            ...
            {
                var layoutQualifier = constantBuffer.Qualifiers.OfType<BiglandsEngine.Core.Shaders.Ast.Glsl.LayoutQualifier>().FirstOrDefault();
                if (layoutQualifier == null)
                {
                    layoutQualifier = new BiglandsEngine.Core.Shaders.Ast.Glsl.LayoutQualifier();
