...
{
    public partial class BiglandsEngineGrammar
    {
        ...
        protected override void CreateStorageQualifier(ParsingContext context, ParseTreeNode node)
        {
            ...
            {
                qualifier = BiglandsEngineStorageQualifier.Parse(node.ChildNodes[0].Token.Text);
        ...
        {
            node.AstNode = BiglandsEngineConstantBufferType.Parse(node.ChildNodes[0].Token.Text);
        }
