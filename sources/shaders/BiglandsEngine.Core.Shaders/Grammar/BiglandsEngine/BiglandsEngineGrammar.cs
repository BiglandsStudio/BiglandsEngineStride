...
using BiglandsEngine.Core.Shaders.Ast.BiglandsEngine;
using BiglandsEngine.Core.Shaders.Grammar.Hlsl;

namespace BiglandsEngine.Core.Shaders.Grammar.BiglandsEngine
{
    [Language("hotei2", "5.0", "BiglandsEngine2 hlsl grammar")]
    public partial class BiglandsEngineGrammar : HlslGrammar
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BiglandsEngineGrammar"/> class.
        /// </summary>
        public BiglandsEngineGrammar()
        {
