...
using ParameterQualifier = BiglandsEngine.Core.Shaders.Ast.Hlsl.ParameterQualifier;
using StorageQualifier = BiglandsEngine.Core.Shaders.Ast.Hlsl.StorageQualifier;

namespace BiglandsEngine.Core.Shaders.Grammar.Hlsl
{
    /// <summary>
