...
namespace BiglandsEngine.Metrics.ServerApp.Migrations
{
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BiglandsEngine.Metrics.ServerApp.Models.MetricDbContext>
    {
        ...
        protected override void Seed(BiglandsEngine.Metrics.ServerApp.Models.MetricDbContext context)
        {
