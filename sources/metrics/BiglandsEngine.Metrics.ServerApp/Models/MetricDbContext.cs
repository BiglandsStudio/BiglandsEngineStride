...
using BiglandsEngine.Metrics.ServerApp.Controllers;
using BiglandsEngine.Metrics.ServerApp.Migrations;
    ...
    public class MetricDbContext : DbContext
    {
        ...
        internal static void Initialize()
        {
            ...
            using (var db = new MetricDbContext())
            {
                ...
                AppEditorId = db.GetApplicationId(CommonApps.BiglandsEngineEditorAppId.Guid);
                AppLauncherId = db.GetApplicationId(CommonApps.BiglandsEngineLauncherAppId.Guid);
