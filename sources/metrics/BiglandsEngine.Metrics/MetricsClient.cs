...
namespace BiglandsEngine.Metrics
{
    ...
    {
        private const string RegistryRootKey = @"Software\BiglandsEngine";
        private const string RegistryInstallKey = @"InstallGuid";
        private const string RegistryLastCommonMetricsKey = @"LastCommonMetrics";
        private const string EnvSpecial = "BiglandsEngineMetricsSpecial";
        ...
        public MetricsClient(MetricAppId appId, int? heartbeatRateMs = null, string endpointUrl = null, string versionOverride = null)
        {
            ...
            if (endpointUrl == null)
            {
                endpointUrl = "https://metrics.BiglandsEngine3d.net";
            }
        ...
        /// <summary>
        /// Opens a new BiglandsEngine project session
        /// </summary>
        ...
        /// <summary>
        /// Closes a BiglandsEngine project session
        /// </summary>
        ...
        /// <summary>
        /// Reports that a BiglandsEngine project session crashed
        /// </summary>
        ...
        private bool NeedUpdateCommonMetrics()
        {
            ...
            if (appId.Guid != CommonApps.BiglandsEngineEditorAppId.Guid)
            {
                return false;
            }
        ...
        private static Guid GetInstallGuid(MetricAppId appId, out RegistryKey rootRegistryKey, out RegistryKey appKey)
        {
            ...
            var shortName = appId.Name.Replace("BiglandsEngine", string.Empty);
