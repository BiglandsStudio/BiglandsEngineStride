...
using BiglandsEngine.Core.Settings;
...
namespace BiglandsEngine.LauncherApp.Services
{
    public static class LauncherSettings
    {
        ...
        private static readonly SettingsKey<string> PreferredFrameworkKey = new SettingsKey<string>("Internal/Launcher/PreferredFramework", SettingsContainer, "net8.0");
