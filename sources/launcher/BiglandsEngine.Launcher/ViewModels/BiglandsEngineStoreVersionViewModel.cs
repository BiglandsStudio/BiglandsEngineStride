...
{
    /// <summary>
    /// An implementation of the <see cref="BiglandsEngineVersionViewModel"/> that represents an official release coming from the store.
    /// </summary>
    internal sealed class BiglandsEngineStoreVersionViewModel : BiglandsEngineVersionViewModel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BiglandsEngineStoreVersionViewModel"/>
        /// </summary>
        ...
        internal BiglandsEngineStoreVersionViewModel(LauncherViewModel launcher, NugetStore store, NugetLocalPackage localPackage, string packageId, int major, int minor)
        ...
        public ObservableList<BiglandsEngineStoreAlternateVersionViewModel> AlternateVersions { get; } = new ObservableList<BiglandsEngineStoreAlternateVersionViewModel>();
        ...
        private void UpdateAlternateVersions<T>(IEnumerable<T> alternateVersions, Action<BiglandsEngineStoreAlternateVersionViewModel, T> updateAction) where T : NugetPackage
        {
            var updatedViewModels = new HashSet<BiglandsEngineStoreAlternateVersionViewModel>();
            foreach (var alternateVersion in alternateVersions)
            {
                ...
                BiglandsEngineStoreAlternateVersionViewModel alternateVersionViewModel;
                if (index < 0)
                {
                    // If not, add it
                    alternateVersionViewModel = new BiglandsEngineStoreAlternateVersionViewModel(this);
        ...
        {
            return Launcher.RetrieveAllBiglandsEngineVersions();
        }
