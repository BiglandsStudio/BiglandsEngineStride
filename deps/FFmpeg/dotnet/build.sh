...
# 3. Set the current working directory to where ffmpeg sources are installed (e.g. /c/Projects/BiglandsEngine/externals/ffmpeg)

# cmds
# C:\Windows\system32\cmd.exe
# "C:\Program Files (x86)\Microsoft Visual Studio\2017\Professional\VC\Auxiliary\Build\vcvars64.bat"
# C:\workspace\msys64\msys2_shell.cmd -use-full-path
# cd C:\\Dev\\BiglandsEngine\\externals\\ffmpeg
# C:\\Dev\\BiglandsEngine\\deps\\FFmpeg\\Windows\\build.sh
